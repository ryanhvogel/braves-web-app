    ...
    return (
        ...
        <div className='mx-5 p-2 d-flex flex-column flex-wrap float'>
            ...
            <div className='d-flex flex-row align-items-center my-5'>
                <div className='w-50 mx-5 text-left'>
                    <h3>This pie chart shows the distribution of Ian Anderson's
                        ...
                        3-pitch pitcher, with a controlling Changeup.
            ...
            <div className='d-flex flex-row align-items-center my-5'>
                ...
                <div className='w-25 mx-5 text-left'>
                    <h3>There are not significant differences between Ian's pitch distributions when facing right-handed 
            ...
            <div className='justify-content-center align-items-center d-flex flex-row my-5'>
                ...
                is noticeable. As previously mentioned, Ian is konwn for his Changeup.
                <br/><br/>
            ...
            <div className='justify-content-center align-items-center d-flex flex-row my-5'>
                ...
                His Changeup leads his pitch types in Swing % by 8 percentage points and averages a 16% whiff rate.
